const HomeIcons = ({size}) => {
    return(
        <svg role="img"  xmlns="http://www.w3.org/2000/svg"  width={size} height={size} aria-hidden="true"  viewBox="0 0 24 24" data-encore-id="icon">
...
const ListIcon = ({size}) => {
    return(
        <svg role="img" xmlns="http://www.w3.org/2000/svg" width={size} height={size} aria-hidden="true" viewBox="0 0 16 16" data-encore-id="icon">
...
const DownloadIcon = ({size}) => {
    return(
        <svg role="img" xmlns="http://www.w3.org/2000/svg" width={size} height={size} viewBox="0 0 24 24" >
...
const DownIcon = ({size}) => {
    return(
        <svg role="img" xmlns="http://www.w3.org/2000/svg" width={size} height={size} viewBox="0 0 16 16" >
...
const ExportIcon = ({size}) => {
    return(
        <svg role="img" width={size} height={size} aria-hidden="true" viewBox="0 0 16 16" data-encore-id="icon">
...
const PlayIcon = ({size}) => {
    return(
        <svg role="img" width={size} height={size} aria-hidden="true" viewBox="0 0 24 24" data-encore-id="icon">
...
const UpMusicIcon = ({size}) => {
    return(
        <svg role="img" width={size} height={size} aria-hidden="true" viewBox="0 0 16 16" data-encore-id="icon">
            <path fill="currentColor" d="M.47 11.03a.75.75 0 001.06 0L8 4.56l6.47 6.47a.75.75 0 101.06-1.06L8 2.44.47 9.97a.75.75 0 000 1.06z"></path>
        </svg>
    )
}


const StopMusicIcon = ({size}) => {
    return(
        <svg xmlns="http://www.w3.org/2000/svg" role="img" width={size} height={size} aria-hidden="true" viewBox="0 0 16 16" data-encore-id="icon">
...
const LoopMusicIcon = ({size}) => {
    return(
        <svg xmlns="http://www.w3.org/2000/svg" className="opacity-50 hover:opacity-100" role="img" width={size} height={size} aria-hidden="true" viewBox="0 0 16 16" data-encore-id="icon">
...
const WindowMusicIcon = ({size}) => {
    return(
        <svg xmlns="http://www.w3.org/2000/svg" role="img" width={size} height={size} aria-hidden="true" viewBox="0 0 16 16" data-encore-id="icon">
            <g fill="currentColor" fill-rule="evenodd"><path d="M1 3v9h14V3H1zm0-1h14a1 1 0 0 1 1 1v10a1 1 0 0 1-1 1H1a1 1 0 0 1-1-1V3a1 1 0 0 1 1-1z" fill-rule="nonzero"></path><path d="M10 8h4v3h-4z"></path></g>
        </svg>
    )
}

const ListMusicIcon = ({size}) => {
    return(
        <svg xmlns="http://www.w3.org/2000/svg" role="img" width={size} height={size} aria-hidden="true" viewBox="0 0 16 16" data-encore-id="icon">
...
const ConnectDeviceMusicIcon = ({size}) => {
    return(
        <svg xmlns="http://www.w3.org/2000/svg" role="img" width={size} height={size} aria-hidden="true" viewBox="0 0 16 16" data-encore-id="icon">
...
const Icon = ({name,size = 24}) => {
    const icons = {
        ...
        stopMusic:StopMusicIcon,
        nextMusic:NextMusicIcon,
        backMusic:BackMusicIcon,
        randomMusic:RandomMusicIcon,
        loopMusic:LoopMusicIcon,
        likeMusic:LikeMusicIcon,
        windowMusic:WindowMusicIcon,
        listMusic:ListMusicIcon,
        connectMusic:ConnectDeviceMusicIcon,
        soundMusic:SoundMusicIcon,
        soundOffMusic:SoundOffMusicIcon,
        soundMidMusic:SoundMidMusicIcon,
        soundLowMusic:SoundLowMusicIcon,
        up:UpMusicIcon,
        fullScreen:FullScreenIcon,
        offFull: FullScreenOffIcon,
        logoFull : LogoIcon,
    }
